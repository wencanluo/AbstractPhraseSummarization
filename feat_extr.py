...
if __name__ == '__main__':
    ...
    input_dir = '/Users/feiliu/Data/SemanticSumm/Proxy/gold/split/dev/'
    body_file = 'aligned-amr-release-1.0-dev-proxy-body.txt'
    summ_file = 'aligned-amr-release-1.0-dev-proxy-summary.txt'
    
    corpus = None#buildCorpus(os.path.join(input_dir, body_file),
                 #W        os.path.join(input_dir, summ_file))
...
#                 feat_vec += feat_extr.getEdgeFeats(k_edge, v_edge, tag, curr_filename, my_nodes, my_edges)
        ...
        print 'extracting features for file: %s' % curr_filename
