...
import TAC_get_ngram_NP
import TAC_get_ngram_pos
import TAC_get_ngram_tfidf
...
if __name__ == '__main__':   
    ...
    for ilpdir in [#"../../data/ILP_Sentence_Supervised_FeatureWeighting/",
        ...
        TAC_get_ngram_NP.extact_inNP(ilpdir, sennadatadir, np = 'sentence', ngram=config.get_ngrams())
        TAC_get_ngram_tfidf.extact_tfidf(ilpdir, np = 'sentence', ngram=config.get_ngrams())
        TAC_get_ngram_pos.extact_pos(ilpdir, sennadatadir, np = 'sentence', ngram=config.get_ngrams())
